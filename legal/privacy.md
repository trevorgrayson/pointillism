...
* **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Trevor Grayson dba ipsum, Santa Monica, CA.
...
* **Derivative Data** refers to files created by the Service, generated by the use of the Service, using files provided by You or Third-Parties.
...
Usage Data will include information in order to provide our Services.  Best effort will be made to only collect the data pertinent to providing services.  This includes, but is not limited to:

* github.com user name
* github.com repository names
* github.com Authorization Credentials
...
Access to Data provided by the Service is protected using tokens.  You assume responsibility for the handling, sharing, and protection of tokens for your Data.
...
By email: [trevor@ipsumllc.com](mailto:trevor@ipsumllc.com)
